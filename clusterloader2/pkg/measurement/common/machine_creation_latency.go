...
func convertedToMachine(obj runtime.Object) (*v1alpha3.Machine, error) {
	machine := &v1alpha3.Machine{}
	err := runtime.DefaultUnstructuredConverter.FromUnstructured(obj.(*unstructured.Unstructured).UnstructuredContent(), machine)
	if err != nil {
		klog.V(2).Infof("Failed to convert object to v1alpha3.Machine...")
		return machine, err
	}
	return machine, nil
}

func createMetaNamespaceKey(machine *v1alpha3.Machine) (string, error) {
